...
public class AqlUtils {
    ...
    public static String getBuildName(String build) {
    ...
    public static String getBuildNumber(ArtifactoryDependenciesClient client, String buildName, String build, Log log) throws IOException {
        String buildNumber = "";
        if (StringUtils.isNotBlank(buildName)) {
            ...
            if (retrievedBuildNumber == null) {
                logBuildNotFound(buildName, buildNumber, log);
            }
    ...
    private static void logBuildNotFound(String buildName, String buildNumber, Log log) {
    ...
    public static String buildIncludeQueryPart(String[] sortByFields, String suffix) {
    ...
    public static String buildQuerySuffix(String[] sortBy, String sortOrder, String offset, String limit) {
     ...
     */
    public static List<AqlSearchResult.SearchEntry> filterAqlSearchResultsByBuild(List<AqlSearchResult.SearchEntry> itemsToFilter, Map<String, Boolean> buildArtifactsSha1, String buildName, String buildNumber) {
     ...
     */
    public static Map<String, Boolean> extractSha1FromAqlResponse(List<AqlSearchResult.SearchEntry> searchResults) {
        Map<String, Boolean> resultsMap = new HashMap<>();
        searchResults.forEach((result) -> resultsMap.put(result.getActualSha1(), true));
        return resultsMap;
    }

    public static String createAqlBodyForBuild(String buildName, String buildNumber) {
