...
public class ArtifactBuilderTest {
    ...
    public void testDefaultBuild() {
        ...
        assertNull(artifact.getSha2(), "Default artifact SHA2 checksum should be null.");
    ...
    public void testBuilderSetters() {
        ...
        Artifact artifact = new ArtifactBuilder(name).type(type).sha1(sha1).sha2(sha2).md5(md5).properties(properties)
                .build();
        ...
        assertEquals(artifact.getSha2(), sha2, "Unexpected artifact SHA2 checksum.");
