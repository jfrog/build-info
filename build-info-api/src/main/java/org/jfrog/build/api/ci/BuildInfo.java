...
import org.jfrog.build.api.builder.BuildBuilder;
import org.jfrog.build.api.builder.BuildModuleBuilder;
...
import static org.jfrog.build.api.ci.BuildBean.ROOT;
...
public class BuildInfo extends BaseBuildBean {
    ...
    private void addModule(org.jfrog.build.api.ci.Module other) {
    ...
    public Build ToBuild() {
        BuildBuilder builder = new BuildBuilder(name)
                .number(number)
                .setProject(project)
                ...
                .licenseControl(licenseControl == null ? null : licenseControl.ToLicenseControl())
