...
public class BuildInfoModuleBuilder {
     ...
     */
    public BuildInfoModuleBuilder type(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder id(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder repository(String repository) {
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder sha1(String sha1) {
        this.sha1 = sha1;
        return this;
    }
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder md5(String md5) {
        this.md5 = md5;
        return this;
    }
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder artifacts(List<Artifact> artifacts) {
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder excludedArtifacts(List<Artifact> excludedArtifacts) {
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder addArtifact(Artifact artifact) {
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder addExcludedArtifact(Artifact artifact) {
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder dependencies(List<Dependency> dependencies) {
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder addDependency(Dependency dependency) {
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder properties(Properties properties) {
     ...
     * @return Builder instance
     */
    public BuildInfoModuleBuilder addProperty(Object key, Object value) {
        if (properties == null) {
