...
public class DockerPull extends PackageManagerExtractor {
    ...
    ArtifactoryClientConfiguration.BuildInfoHandler buildInfo;
    String imageTag;
    String host;
    Log logger;
    ...
    public Build execute() {
        ...
        logger.info(message);
        DockerAgentUtils.pullImage(imageTag, username, password, host, env);
    ...
    public static void main(String[] ignored) {
        try {
            ...
            ArtifactoryDependenciesClientBuilder clientBuilder = new ArtifactoryDependenciesClientBuilder().setClientConfiguration(clientConfiguration, clientConfiguration.publisher);
